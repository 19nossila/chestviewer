...
public class ChestViewer {
  ...
  public Map<PathPoint, ItemStack[]> inventoryMap = (Map)new LinkedHashMap<>();
  
  public Map<PathPoint, String> inventoryNameMap = new LinkedHashMap<>();
  
  public Map<Integer, ItemStack[]> entityInventoryMap = new LinkedHashMap<>();
  public Map<Integer, String> entityInventoryNameMap = new LinkedHashMap<>();
